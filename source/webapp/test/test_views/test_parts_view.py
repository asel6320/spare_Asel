...
class TestPart(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.unrelated_part = PartFactory(name='related part3', category=CategoryFactory(name='bb'))
    ...
    def setUp(self):
        ...
        self.unrelated_part = PartFactory(vehicle_info__countries=[self.another_country])
        self.price1 = PriceHistoryFactory(part=self.part1, price=200.00)
        self.price2 = PriceHistoryFactory(part=self.part2, price=100.00)
        self.price_unrelated = PriceHistoryFactory(part=self.unrelated_part, price=300.00)
