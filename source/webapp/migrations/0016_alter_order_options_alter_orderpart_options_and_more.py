    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="В обработке", max_length=50, verbose_name="Статус заказа"
            ),
        ),
        migrations.AddField(
            ...
            name="created_at",
            field=models.DateTimeField(
                auto_now_add=True, default=None, verbose_name="Дата продажи"
            ),
        ...
        migrations.AddField(
            ...
            name="name",
            field=models.CharField(
                default=None, max_length=150, verbose_name="Название"
            ),
            preserve_default=False,
        ),
        migrations.AddField(
            ...
            field=models.DecimalField(
                decimal_places=2, default=None, max_digits=7, verbose_name="Цена"
            ),
            preserve_default=False,
        ),
